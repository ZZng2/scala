...
/**
 * HeroSection
 * 랜딩 페이지의 스크롤 기반 3단계 Fade Animation
 * 
 * PRD 기준:
 * - 1단계: "2025년에 놓친 동국대학교 장학금"
 * - 2단계: "361개" (숫자 강조)
 * - 3단계: "PUSH 알림만 켜두세요. 이번 학기는 무조건 받게 해드릴게요."
 */
            ...
            <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden pt-[56px] md:pt-[64px]">
                ...
                >
                    <div className="space-y-2">
                        <p className="text-3xl md:text-5xl font-bold text-[#212121] leading-tight">
                            2025년에 놓친
                        </p>
                        <p className="text-3xl md:text-5xl font-bold text-[#FF6B35] leading-tight">
                            동국대학교 장학금
                        </p>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="absolute inset-0 flex flex-col items-center justify-center text-center px-6"
                >
                    <p className="text-8xl md:text-9xl font-extrabold text-[#FF6B35] tracking-tighter">
                        361개
                    </p>
                </motion.div>
                ...
                >
                    <div className="space-y-4">
                        <p className="md:text-4xl text-[#212121] leading-relaxed font-bold text-[24px]">
                            <span className="text-[#FF6B35] text-4xl md:text-6xl font-bold">PUSH 알림</span>만 켜두세요.<br />
                            <span className="font-bold mt-2 block text-[32px] md:text-[40px]">이번 학기는<br />무조건 받게 해드릴게요.</span>
                        </p>
                    </div>
                </motion.div>
