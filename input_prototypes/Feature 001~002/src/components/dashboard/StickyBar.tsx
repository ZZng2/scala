...
function Text() {
  return (
    <Text2 additionalClassNames="h-[18.754px]">
      <p className="font-['Pretendard',sans-serif] font-bold leading-[18.75px] not-italic relative shrink-0 text-[15px] text-nowrap text-white">정보가 임시 저장 중이에요!</p>
    </Text2>
  );
}
...
function Text1() {
  return (
    <Text2 additionalClassNames="h-[13.75px] opacity-90">
      <p className="font-['Pretendard',sans-serif] font-normal leading-[13.75px] not-italic relative shrink-0 text-[11px] text-nowrap text-white">카카오로 3초 만에 가입하고 알림 받기</p>
    </Text2>
  );
}
...
function Button() {
  return (
    <div className="bg-white h-[31.998px] relative rounded-[23px] shrink-0 w-[72.367px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
        <p className="font-['Pretendard',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#ff6b35] text-[14px] text-center text-nowrap">가입하기</p>
      </div>
    </div>
  );
}
